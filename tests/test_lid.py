...
def test_mms_lid_mocked(mocker):
    mocker.patch('project.models.mms_lid.Wav2Vec2ForSequenceClassification.from_pretrained')
    mocker.patch('project.models.mms_lid.Wav2Vec2FeatureExtractor.from_pretrained')
